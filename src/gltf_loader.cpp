																							...
																							int tangent_accessor_index)
{
	...
	glm::vec3 min { float(vertex_accessor.minValues[0]),
					float(vertex_accessor.minValues[1]),
					float(vertex_accessor.minValues[2]) };
	glm::vec3 max { float(vertex_accessor.maxValues[0]),
					float(vertex_accessor.maxValues[1]),
					float(vertex_accessor.maxValues[2]) };
